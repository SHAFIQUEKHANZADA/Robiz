...
const WinnterCollection = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const response = await fetch(`/api/products/jacket`);
    ...
    return (
        <div className={`${archivo.className} pb-7 sm:pl-0 pl-2`}>
            <div data-aos="fade-up" data-aos-duration="600" className="md:px-10 px-4  text-left flex flex-col justify-center mb-5">
                <h2 className="sm:text-[30px] text-[22px] font-medium mb-2 text-[#111111] uppercase">
                Winter Essentials
                </h2>
...
export default WinnterCollection;
